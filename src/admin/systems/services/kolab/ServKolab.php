...
class ServKolab extends GoService
{
    ...
    var $postfix_mydestinationList = null;
    var $postfix_mynetworksList = null;
    var $hostname = '';
    ...
    function execute()
    {
        ...
        $edit       = sprintf(
            '<input name="kolabFreeBusyFuture" value="%s" type="text" maxlength="3" size="4">',
        ...
        $edit       = sprintf(
            '<input name="cyrus_quotawarn" value="%s" type="text" maxlength="3" size="4">',
